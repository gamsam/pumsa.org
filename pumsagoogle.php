          ...
          <div class="row">
            <div class="col-md-4">
              <div class="agent-avatar-box">
                <img src="img/pumsagoogleclear.jpg" alt="" class="agent-avatar img-fluid">
              </div>
            </div>
              ...
              <div class="agent-info-box">
                <div class="agent-title">
                  <div class="title-box-d">
                    <h3 class="title-d"> PUMSA Powered Google Digital Skills Training </h3>
                  </div>
                </div>
              ...
              <div class="col-sm-12 col-md-9">
                ...
                <div class="testimonials-content">
                  <p class="testimonial-text">
                    "I had a wonderful experience at the Google Digital Skills Taining organized by PUMSA. It  was a very interactive session learning while having fun. The tutor was kind, and she took her time to explain a lot of conceptsconcemed with the digital environment, which most of us were not familiar with. <br> <br>
                ...
                <div class="testimonial-author-box">
                  <img src="img/cecilia.jpg" alt="" class="testimonial-avatar">
                  <h5 class="testimonial-author">Cecilia Orumie</h5>
                </div>
              </div>
            </div>
          </div>
...
<!--/ Testimonials End /-->
                    Watch out for more innovative projects from the Rotifa Femi led PUMSA Executives.
                  </p>
