      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">7 Habits of Happy Men</h1>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="news-img-box">
            <img src="img/happymenpot.jpg" alt="" class="img-fluid" style="width: 100%;">
          </div>
        </div>
          ...
          <div class="post-information">
            <ul class="list-inline text-center color-a">
              <li class="list-inline-item mr-2">
                ...
                <span class="color-text-a"> Icheka Ozuru </span>
              </li>
              <li class="list-inline-item mr-2">
              ...
              <li class="list-inline-item">
                <strong>Date: </strong>
                <span class="color-text-a"> 1st December, 2019</span>
              </li>
            </ul>
          </div>
          <div class="post-content color-text-a" style="text-align: justify;">
            <strong style="font-size: 1.4rem; color: black;"> 7 Habits of Happy Men </strong> <br> <br>
            <p>
              Male unhappiness creates an emotional deficit that often bleeds over into men’s relationships, their jobs, and their health. Studies reveal that unhappiness among men can result in emotional isolation, depression, anger issues, physical sickness, and even early demise.
            </p>
            <p>
            ...
            <strong style="color: black;">1. Pursuing Life Goals</strong>
            <p>
            ...
            <blockquote class="blockquote">
              <p class="mb-4">“Principles are the fundamental truths that serve as behaviors that get you what you want out of life.”</p>
              <footer class="blockquote-footer">
                <cite title="Source Title">Ray Dalio</cite>
              </footer>
            </blockquote>
            ...
            <strong style="color: black;">2. Gratitude As A Practice</strong>
            <p>
            ...
            <strong style="color: black;">3. Daily Exercise </strong>
            <p>
              In the book “Spark: The Revolutionary New Science of Exercise and the Brain”, the authors make the case that if pharmaceutical companies could squeeze all the mental and emotional benefits of physical exercise into a pill, the world’s population would be beating at their gates to buy it.
            </p>
            <p>
            ...
            <p>
              Just 20 minutes of daily exercise can put you on the path to greater happiness and resiliency, so get moving today. 
            </p>

            <strong style="color: black;">4. Making Progress</strong>
            <p>
            ...
            <strong style="color: black;">5. Forgiveness</strong>
            <p>
              <blockquote class="blockquote">
                “Forgiveness is the fragrance of the violet on the heel of the one who crushed it,”
              </blockquote>
              said <strong style="color: black;">Mark</strong> Twain, renowned American author of “Tom Sawyer”, “Huckleberry Finn” and several other classics. 
            </p>
            <p>
            ...
            <strong style="color: black;">6. Mindfulness</strong>
            <p>
            ...
            <strong style="color: black;">7. Socializing</strong>
            <p>
            ...
            <strong style="color: black;">Making It a Priority</strong>
            <p>
