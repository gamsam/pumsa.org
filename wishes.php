      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">Wishes</h1>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="news-img-box">
            <img src="img/wishes.jpg" alt="" class="img-fluid" style="width: 100%;">
          </div>
        </div>
        <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
          <div class="post-information">
            <ul class="list-inline text-center color-a">
              <li class="list-inline-item mr-2">
                ...
                <span class="color-text-a">Tochi Izuheihe </span>
              </li>
              <li class="list-inline-item mr-2">
                <strong>Category: </strong>
                <span class="color-text-a"> Inspirational </span>
              </li>
          ...
          <div class="post-content color-text-a" style="text-align: justify;">
            <strong style="font-size: 1.4rem;"> Wishes </strong> <br> <br>
            <p>
