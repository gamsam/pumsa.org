            ...
            <div class="col-md-7" style="margin: 0 auto;">
              <form class="form-a contactForm" action="contactform/contactform.php" method="POST" role="form">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3">
                    <div class="form-group">
                      <input type="password" name="password" class="form-control form-control-lg form-control-a" placeholder="Repeat Password" data-rule="minlen:6" data-msg="Please enter a minimum of 6 characters">
                      <div class="validation"></div>
                    </div>
                  </div>
