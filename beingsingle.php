      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">Being Single</h1>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="news-img-box">
            <img src="img/beingsingle.jpg" alt="" class="img-fluid" style="width: 100%;">
          </div>
        </div>
        <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
          <div class="post-information">
            <ul class="list-inline text-center color-a">
              <li class="list-inline-item mr-2">
                ...
                <span class="color-text-a">www.verilymag.com </span>
              </li>
              <li class="list-inline-item mr-2">
          ...
          <div class="post-content color-text-a" style="text-align: justify;">
            <strong style="font-size: 1.4rem;"> Being Single </strong> <br> <br>
            <p><strong>
            ...
            <p>
              Expressing discontent with one’s love life (or lack thereof) is fine for a particularly hard day, PMS (Pre-menstrual syndrome), or an understandable moment of weakness. But too often, complaining about being single is viewed as a go-to conversation for single women. “Girls night out” topics may range from theories about why there are no good men out there to statements of blatant self-deprecation. And while the seminar may be laced with dry humor and endless rounds of cocktails, it all falls under the same depressing umbrella.
            </p>
            <p>
            ...
            <blockquote class="blockquote">01. Your friends probably want to talk about something else.</blockquote>
            <p>
            ...
            <blockquote class="blockquote">02. It’s counterproductive.</blockquote>
            <p>
            ...
            <blockquote class="blockquote">03. Not everyone is a counselor.</blockquote>
            <p>
              Not everyone is capable of the response you’re looking for when you need an ear to vent, especially if you whine often and have developed a bit of a reputation (think: <em>The Boy Who Cried Wolf</em>). It can be incredibly disheartening to pour your heart out time and time again and receive the same responses of apathy or even silence. Rather than setting yourself up to feel misunderstood and disappointed with everyone you open up to, reserve a select few friends to go to when you’re in dire need of encouragement. Make sure these people know you well and always give them a heads up before you dive into that three-hour snivel session you crave.
            </p>

            <blockquote class="blockquote">04. There are a hundred other important things you could be discussing.</blockquote>
            <p>
