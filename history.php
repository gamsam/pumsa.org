      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">Our History</h1>
            <span class="color-text-a">Learn about the history of the Port Harcourt University Medical Students' Association</span>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="news-img-box">
            <img src="img/history.jpg" alt="PUMSA Profile" class="img-fluid" width="100%">
          </div>
        </div>
        <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2" style="text-align: justify; font-size: 1.1rem; margin-top: 3rem;">
            <p><strong>
